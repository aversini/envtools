...
function start(vmname, useGui, callback) {
  ...
  vboxmanage('-nologo startvm "' + vmname + '"' + startOpts, function(
    error,
    stdout
  ) {
...
function acpipowerbutton(vmname, callback) {
  ...
  vboxmanage('controlvm "' + vmname + '" acpipowerbutton', function(
    error,
    stdout
  ) {
    callback(error);
...
function acpisleepbutton(vmname, callback) {
  ...
  vboxmanage('controlvm "' + vmname + '" acpisleepbutton', function(
    error,
    stdout
  ) {
    callback(error);
...
var guestproperty = {
  ...
  os: function(vmname, callback) {
    ...
    try {
      exec(
        vBoxManageBinary + 'showvminfo -machinereadable "' + vmname + '"',
        getOSTypeCallback
      );
    } catch (e) {
