var
  ...
  REQUREST_TERMINAL_THEME = 'r_terminal_theme';
...
function _buildOptions(options, callback) {
  ...
  _addChoice({
    name: options.i18n.t('bootstrap.terminalTheme'),
    short: 'Extract Terminal Theme',
    value: REQUREST_TERMINAL_THEME,
    type: [common.TYPE_EXTRA],
    fct: plugins.terminalTheme,
    restrictOs: ['darwin']
  });
